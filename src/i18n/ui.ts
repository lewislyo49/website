...
export const ui = {
  en: {
    ...
    introTitle: "HI, I'M LEWIS", introRole: 'Graphic Designer / Video Editor / VFX Artist',
    pioneerTitle: 'LUMINA TRAILBLAZER', pioneerBody: 'Born from a childhood fascination with electronic worlds, this original character took shape in 2020 and now carries my experience, visual language, and creative life.', learnMore: 'Learn more',
    servicesTitle: 'WHAT CAN I DO?', servicesLead: 'Creative solutions across video, virtual branding, and graphic design.',
  ...
  zh: {
    ...
    introTitle: '嗨，我是 LEWIS', introRole: '平面设计师 / 视频剪辑师 / VFX 艺术家',
    pioneerTitle: '来明先锋', pioneerBody: '形象源于我儿时对电子世界的幻想，2020 年开始获得最初设定，并在持续创作中承载了我的经验、视觉语言与生命力。', learnMore: '了解更多',
    servicesTitle: '我能做什么？', servicesLead: '涵盖视频、虚拟品牌与平面设计的完整视觉解决方案。',
  ...
  ja: {
    ...
    introTitle: 'こんにちは、LEWISです', introRole: 'グラフィックデザイナー / 映像編集 / VFXアーティスト',
    pioneerTitle: 'ルミナ・トレイルブレイザー', pioneerBody: '幼少期に思い描いた電子世界への憧れから生まれ、2020年に形を得たオリジナルキャラクターです。今では私の経験と映像表現を宿す存在になりました。', learnMore: '詳しく見る',
    servicesTitle: 'できること', servicesLead: '映像、バーチャルブランディング、グラフィックを横断したビジュアル制作。',
